...
export default function Profile() {
  ...
  const followedGroups = useMemo(
    () => followedSources.filter((f) => f.target.startsWith("*@")),
    [followedSources]
  );
  ...
  const [correctReenteredPassword, setCorrectReenteredPassword] = useState(
    null
  );
      ...
      <div className="flex flex-row pt-2 space-x-2 justify-center">
        <div>
          <DashboardPanel collapsable={false}>
            <DashboardPanel.Header></DashboardPanel.Header>
            <DashboardPanel.Body>
          ...
          <DashboardPanel collapsable={false}>
            <DashboardPanel.Header>Menu</DashboardPanel.Header>
            <DashboardPanel.Body>
              <SimpleMenu
                options={[
        ...
        <div className="w-128">
          <MenuPages index={selectedPage}>
            ...
            <DashboardPanel restrictedHeight={false} collapsable={false}>
              <DashboardPanel.Header>Account Settings</DashboardPanel.Header>
              <DashboardPanel.Body>
                <TabbedView options={["Change Email", "Change Password"]}>
                  <div>
                    <form onSubmit={onSubmit1}>
                      ...
                      <div className="block text-700 text-md font-bold mb-2">
                        Your email: {email}{" "}
                      </div>
                      <FormInput2
                        type={"text"}
                  ...
                  <div>
                    <form onSubmit={onSubmit}>
                      ...
                      <FormInput2
                        ...
                        checker={(val) => [
                          val !== oldPassword,
                          "Your new password cannot be same as your old password",
                        ]}
                        setCorrectValue={setCorrectPassword}
                      />
                      <FormInput2
            ...
            <DashboardPanel restrictedHeight={false} collapsable={false}>
              <DashboardPanel.Header>Delete Your Account</DashboardPanel.Header>
              <DashboardPanel.Body>
                <div>Your account will be deleted permanently.</div>
                <div>
                  <button
                    className="bg-yellow-50 text-blue-50 py-2 px-4 my-5 rounded"
                    onClick={delete_user}
                  >
                    Delete Account
                  </button>
